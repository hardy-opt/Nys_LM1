function  nys_curve_expLM(darg,col) %4.8446772001339822e-01
     clc;
%     clear;
    close all;
...
%                                 end
                                ...
                                if m==1
                                   ...
                                   [w_s1, info_s1] = Nystrom_svrg(problem, options,reg,del);  % NSVRG-
                                   save(Name,'info_s1');
                                ...
                                elseif m==2
                                    ...
                                    [w_s1, info_s1] = Nystrom_sgd(problem, options,reg,del); % NSGD-
                                    save(Name,'info_s1');
                                    %end
                                elseif m==3
